...
import InformasiMitra from "./InformasiMitra";
          ...
          <Card.Body>
            <Form
              onSubmit={(event) => {
                ...
                setContent(React.createElement(InformasiMitra));
              }}
            >
              <Form.Group as={Row} className="mb-4">
                ...
                <Col sm={8}>
                  <Row>
                    ...
                    <Col sm="auto">
                      <Form.Check type="radio" label="VCC" name="method" />
                    </Col>
                  </Row>
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-4">
                ...
                <Col sm={8}>
                  <Form.Control
                    type="text"
                    name="account"
                    placeholder="Masukkan Nomor Akun Bank Anda"
                  />
                </Col>
              </Form.Group>
              <Form.Group as={Row} className="mb-4">
                ...
                <Col sm={8}>
                  <Form.Control
                    type="text"
                    name="holder"
                    placeholder="Masukkan Nama Pemilik Akun Bank Anda"
                  />
                </Col>
              </Form.Group>
              <Form.Group as={Row} className="mb-4">
